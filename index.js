// AI Character Generator - 最终版（可编辑结果 + 纯净白底黑字）
(function() {
    setTimeout(() => {
        try {
            initPlugin();
        ...
        function createPanel() {
            ...
            panel.innerHTML = `
                ...
                <div class="ai-tab-content" id="tab-char">
                    <div class="ai-setting-group">
                        <label>简单设定</label>
                        <textarea id="ai-char-input" rows="3" placeholder="例如：她是个女人，叫小美，喜欢猫"></textarea>
                    </div>
                    <div class="ai-button-group">
                    ...
                    <div class="ai-setting-group">
                        ...
                        <textarea id="ai-char-result" class="editable-result" rows="12" readonly placeholder="生成结果会显示在这里，你可以直接修改..."></textarea>
                    </div>
                    <div class="ai-button-group">
                ...
                <div class="ai-tab-content" id="tab-user">
                    ...
                    <div class="ai-setting-group">
                        <label>生成结果 (可直接编辑)</label>
                        <textarea id="ai-user-result" class="editable-result" rows="12" readonly placeholder="生成结果会显示在这里，你可以直接修改..."></textarea>
                    </div>
                    <div class="ai-button-group">
            ...
            charResult.addEventListener('input', () => {
                charCopy.disabled = !charResult.value;
                charImport.disabled = !charResult.value;
            });
            userResult.addEventListener('input', () => {
                userCopy.disabled = !userResult.value;
                userImport.disabled = !userResult.value;
            });
