// AI Character Generator - 完整版（双模板统一）
(function() {
    setTimeout(() => {
        try {
            initPlugin();
  ...
  NSFW_information:
    ...
    Limits:`;
        ...
        // 用户人设模板（将 char_name 替换为 user_name）
        ...
        function createPanel() {
            ...
            panel.innerHTML = `
                ...
                <div class="ai-tab-content" id="tab-char">
                    <div class="ai-setting-group">
                        <label>简单设定</label>
                        <textarea id="ai-char-input" rows="3" placeholder="例如：前锋，所有屠孝子心里最柔软的地方"></textarea>
                    </div>
                    <div class="ai-button-group">
                    ...
                    <div class="ai-setting-group">
                        <label>生成结果</label>
                        <textarea id="ai-char-result" rows="10" readonly placeholder="生成结果会显示在这里..."></textarea>
                    </div>
                    <div class="ai-button-group">
                ...
                <div class="ai-tab-content" id="tab-user">
                    ...
                    <div class="ai-setting-group">
                        <label>生成结果</label>
                        <textarea id="ai-user-result" rows="10" readonly placeholder="生成结果会显示在这里..."></textarea>
                    </div>
                    <div class="ai-button-group">
            ...
            charGenerate.onclick = async () => {
                ...
                const result = await generateCharacter(input, 'character', charGenerate);
                if (result) {
                    charResult = result;
            ...
            userGenerate.onclick = async () => {
                ...
                const result = await generateCharacter(input, 'user', userGenerate);
                if (result) {
                    userResult = result;
            ...
            userImport.onclick = () => { if (userResult) { copyToClipboard(userResult); toastr.info('已复制，请去用户设置 → 人设管理 → 粘贴'); } };
