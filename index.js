// AI Character Generator - 完美主题适配版
(function() {
    setTimeout(() => {
        try {
            initPlugin();
...
function getThemeVariables() {
    ...
    return {
        ...
        text: computed.getPropertyValue('--SmartThemeBodyColor') || '#333',
        border: computed.getPropertyValue('--SmartThemeBorderColor') || '#ddd',
        inputBg: computed.getPropertyValue('--SmartThemeBlurTintColor') || '#fff'
    };
}
...
function applyTheme() {
    ...
    if (config.themeMode === 'fixed') {
        ...
        styleEl.textContent = `
            ...
            .ai-char-panel[style*="background: #ffffff"] input[type="range"] {
                -webkit-appearance: none;
                background: #cccccc !important;
                height: 4px !important;
                border-radius: 2px !important;
            }
            .ai-char-panel[style*="background: #ffffff"] input[type="range"]::-webkit-slider-thumb {
                -webkit-appearance: none;
        ...
        panelEl.style.removeProperty('border');
    }
}
